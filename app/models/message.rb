...
class Message < ActiveRecord::Base
  ...
  def self.add_messages(micropost_id, reciver_id, reciver_types, sender_id, 
    ...
    Message.create(:user_id => reciver_id, :content => m_content, :school_class_id => school_class_id)
    follow_users = FollowMicropost.find_all_by_micropost_id(micropost_id.to_i).maps{|i| i.user_id }
